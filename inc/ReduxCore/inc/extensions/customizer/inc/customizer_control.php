        ...
        class Redux_Customizer_Control extends WP_Customize_Control {
            ...
            public function render() {
                ...
                <li id="<?php echo esc_attr( $this->redux_id ); ?>" class="<?php echo esc_attr( $class ); ?>">
                    <input type="hidden" data-id="<?php echo esc_attr($this->id); ?>" class="redux-customizer-input"
                        id="customizer_control_id_<?php echo esc_attr($this->redux_id); ?>" <?php echo do_shortcode($this->link()) ?>
                        value=""/>
            ...
            public function label() {
                ...
                echo do_shortcode($this->label);
            }

            public function description() {
                if ( ! empty( $this->description ) ) {
                    // The description has already been sanitized in the Fields class, no need to re-sanitize it.
                    echo do_shortcode('<span class="description customize-control-description">' . $this->description . '</span>');
                }
            }
