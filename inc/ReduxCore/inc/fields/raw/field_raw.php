            ...
            function render() {
                ...
                if ( ! empty( $this->field['content'] ) && isset( $this->field['content'] ) ) {
                    if ( isset( $this->field['markdown'] ) && $this->field['markdown'] == true ) {
                        require_once get_template_directory() . '/inc/ReduxCore/inc/fields/raw' . "/parsedown.php";
                        $Parsedown = new Parsedown();
                        echo do_shortcode($Parsedown->text( $this->field['content'] ));
                    } else {
                        echo do_shortcode($this->field['content']);
                    }
                }
