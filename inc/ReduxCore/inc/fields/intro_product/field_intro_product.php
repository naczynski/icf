            ...
            <div class="intro-product">
                ...
                <div class="zo-tools">
                    <ul>
                        ...
                        <li><a href="<?php echo esc_url('http://zotheme.com/forum');?>"><i class="dashicons dashicons-groups"></i><span><?php esc_html_e("Forum Support", 'lucian'); ?></span></a></li>
                        <li><a href="<?php echo esc_url('http://themeforest.net/user/ZoTheme/portfolio?WT.ac=portfolio_item&WT.z_author=ZoTheme');?>"><i class="dashicons dashicons-products"></i><span><?php esc_html_e("ZoTheme", 'lucian'); ?></span></a></li>
                        <li><a href="mailto:wp@zotheme.com"><i class="dashicons dashicons-email"></i><span><?php esc_html_e("Contact Now", 'lucian'); ?></span></a></li>
                    </ul>
                </div>
